...
(function () {
  ...
  function render() {
    ...
    var washDefs = [
      [W * 0.08, H * 0.25, W * 0.35, "210,242,230", 0.10],  // 薄荷绿
      [W * 0.12, H * 0.55, W * 0.30, "252,230,210", 0.09],  // 蜜桃粉
      [W * 0.05, H * 0.80, W * 0.28, "235,230,248", 0.08],  // 薰衣草紫
      [W * 0.18, H * 0.10, W * 0.25, "228,242,225", 0.07]   // 嫩芽绿
    ];
